            ...
            <div class="container px-4 px-lg-5">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        ...
                        <li class="nav-item"><a class="nav-link" href="index.jsp">Produtos</a></li>
        ...
        <header class="bg-dark py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="text-center text-white">
                    ...
                    <p class="lead fw-normal text-white-50 mb-0">Serviços</p>
                </div>
            </div>
        </header>
        <!-- Section-->
                    ...
                    <div class="col">
                        <div class="card">
                          ...
                          <div class="card-body">
                            ...
                            <hr>
                            <p style="color:blck;font-size:20px;text-align:center;">R$<%=rs.getString("valor")%></p>
