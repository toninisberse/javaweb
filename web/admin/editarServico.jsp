                ...
                <main>
                    ...
                    <%
                        ...
                        try {
                            ...
                            rs = st.executeQuery("SELECT *FROM servicos WHERE id = '"+id+"' ");
                            while(rs.next()){ %>
                                <div class="container-fluid px-4">
                                    <small>Formulário de atualização de produto</small>
                                    <form action="config/editarServico.jsp?id=<%=rs.getString("id")%>&imagem=<%=rs.getString("imagem")%>" method="POST" enctype="multipart/form-data">
                                        <div class="mb-3">
