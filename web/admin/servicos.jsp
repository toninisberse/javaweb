        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <div class="container-fluid px-4">
                        <small>Formulário de cadastro de serviços</small>
                        <form action="config/cadastraServico.jsp" method="POST" enctype="multipart/form-data">
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="desc" placeholder="Descrição do serviço"/> 
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Valor do produto</label>
                                <input type="text" class="form-control" name="valor" placeholder="Valor do serviço"/> 
                            </div>
                            <div class="mb-3">
                            ...
                            <tbody>
                                <% 
                                    ...
                                    try{
                                         ...
                                         rs = st.executeQuery("SELECT * FROM servicos ORDER BY id DESC");
                                         while(rs.next()){ 
                                    ...
                                    %>
                                          <tr>
                                              ...
                                              <td>
                                                  <a href="editarServico.jsp?id=<%=rs.getString("id")%>" class="text-info" ><i class="fa fa-pencil-square"></i></a>
                                              ...
                                              <div class="modal-dialog">
                                                <div class="modal-content">
                                                  ...
                                                  <div class="modal-footer">
                                                    ...
                                                    <a href="servicos.jsp?funcao=excluir&id=<%=rs.getString(1)%>&imagem=<%=rs.getString("imagem")%>" class="btn btn-danger">Excluir</a>
                                                  </div>
                                                </div>
                                              </div>
                                            </div>
                    ...
                    <%
                        if(request.getParameter("funcao")!= null && request.getParameter("funcao").equals("excluir")){
                            ...
                            try{
                                ...
                                con = DriverManager.getConnection(url,usuario,senhaBD);
                                st = con.createStatement();
                                st.executeUpdate("DELETE from servicos WHERE id = '"+id+"' ");
                                response.sendRedirect("servicos.jsp?status=3");//Registro deletado com sucesso
                            }catch(Exception e){
                                out.println(e);
                            }
                        }
