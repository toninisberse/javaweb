        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    while(rs.next()){ %>
                         <div class="container-fluid px-4">
                        <small>Formulário de atualização de produtos</small>
                        <form action="config/cadastraProduto.jsp" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" value = "<%=rs.getString("descricao")%>" name="descricao" placeholder="Descrição do produto"/> 
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="file" class="form-control" value = "<%=rs.getString("imagem")%>" name="files[]" multiple /> 
                            </div>
